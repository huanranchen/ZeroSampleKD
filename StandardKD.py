...
def default_kd_loss(student_out, teacher_out=None, label=None, t=4, alpha=1, beta=-0.1):
...
if __name__ == '__main__':
    ...
    student = wrn_40_2(num_classes=100)

    loader: DataLoader = get_CIFAR100_train(augment=True)

    solver = KnowledgeDistillation(teacher, student, eval_loader=get_CIFAR100_test())
    solver.train(loader)
